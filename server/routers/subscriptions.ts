...
export const subscriptionsRouter = router({
  ...
  activateFree: protectedProcedure.mutation(async ({ ctx }) => {
    ...
    if (!canManageBilling) {
      throw new TRPCError({
        code: "FORBIDDEN",
        message: "Only the company owner can change the subscription",
      });
    }
  ...
  redeemPilotAccess: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (!canManageBilling) {
        throw new TRPCError({
          code: "FORBIDDEN",
          message: "Only the company owner can redeem Pilot Access for the company",
        });
      }
  ...
  createPortalSession: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (!canManageBilling) {
        throw new TRPCError({
          code: "FORBIDDEN",
          message: "Only the company owner can access billing management",
        });
      }
