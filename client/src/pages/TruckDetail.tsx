      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div>
              <p className="text-sm text-slate-600 mb-1">Mileage</p>
              <p className="font-semibold text-slate-900">{truck.mileage.toLocaleString()} mi</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-sm text-slate-600 mb-1">Last Inspection</p>
              <p className="font-semibold text-slate-900">{truck.lastInspection.toLocaleDateString()}</p>
            </div>
          </div>
        </div>
      </div>
